...
const pages = [
  ['/', 'index.html', 'Кирило Русанівський — відеомонтажер, графічний дизайнер і фотограф', 'Кирило Русанівський — відеомонтажер, графічний дизайнер і фотограф із Києва. Монтаж відео, дизайн книжок і обкладинок, верстка, репортажна фотографія.'],
  ['/rates/', 'rates/index.html', 'Умови співпраці — Кирило Русанівський', 'Умови роботи та контакти Кирила Русанівського — відеомонтажера, графічного дизайнера і фотографа з Києва.'],
  ['/contacts/', 'contacts/index.html', 'Контакти — Кирило Русанівський', 'Контакти Кирила Русанівського — відеомонтажера, графічного дизайнера і фотографа з Києва.'],
...
const ukrainianProfile = {
  jobTitle: ['Відеомонтажер', 'Графічний дизайнер', 'Фотограф'],
  knowsAbout: [
