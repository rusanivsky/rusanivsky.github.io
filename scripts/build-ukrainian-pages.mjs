...
const pages = [
  ['/', 'index.html', 'Кирило Русанівський — відеомонтажер, графічний дизайнер і фотограф', 'Кирило Русанівський — відеомонтажер, графічний дизайнер і фотограф із Києва. Дизайн книжок і обкладинок, верстка, монтаж відео, репортажна фотографія.'],
