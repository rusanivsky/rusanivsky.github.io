...
function addContactsLink(html, route) {
  ...
  const fontToggle = '<div class="tgl font-toggle" role="group" aria-label="Font"><button type="button" data-font-toggle="prata" aria-pressed="true">F</button><button type="button" data-font-toggle="playfair" aria-pressed="false">P</button><button type="button" data-font-toggle="unbounded" aria-pressed="false">U</button></div>';
