...
const pages = [
  ['/', 'index.html', 'Кирило Русанівський — відеомонтажер, графічний дизайнер і фотограф', 'Кирило Русанівський — відеомонтажер, графічний дизайнер і фотограф із Києва. Монтаж відео, дизайн книжок і обкладинок, верстка, репортажна та портретна фотографія.'],
